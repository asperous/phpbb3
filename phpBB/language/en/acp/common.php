...
$lang = array_merge($lang, array(
	...
	'ACP_CAT_FORUMS'			=> '<i class="icon-th-list"></i> Forums',
	'ACP_CAT_GENERAL'			=> '<i class="icon-dashboard"></i> General',
	'ACP_CAT_MAINTENANCE'		=> '<i class="icon-cogs"></i> Maintenance',
	'ACP_CAT_PERMISSIONS'		=> '<i class="icon-sitemap"></i> Permissions',
	'ACP_CAT_POSTING'			=> '<i class="icon-pencil"></i> Posting',
	'ACP_CAT_STYLES'			=> '<i class="icon-magic"></i> Styles',
	'ACP_CAT_SYSTEM'			=> '<i class="icon-wrench"></i> System',
	'ACP_CAT_USERGROUP'			=> '<i class="icon-group"></i> Users and Groups',
	'ACP_CAT_USERS'				=> 'Users',
